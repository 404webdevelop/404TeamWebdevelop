...
router.register(r'author/(?P<author_id>\d+)/posts', PostByAuthor, base_name='post_by_author')

# Comment views
router.register(r'posts/(?P<post_id>\d+)/comments', CommentByPost, base_name='comment_by_post')
