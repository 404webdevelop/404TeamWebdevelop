...
if (username == "None"){
	...
	document.getElementById("loginbutton").innerHTML ="<a href=\"profile.html\"><u>[ "+username+" ]</u></a><button id=\"logoutbutton\" type=\"button\" onclick=\"logout()\" class=\"btn btn-xs btn-warning\">Logout</button>";
};
