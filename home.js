...
if (username == "None"){
	...
	$("#fot").html("<p><center>please login in to your account<br>If you don't have one please sign up one.</center><p>")
}else{
	...
	document.getElementById("fot").innerHTML= "<div role=\"navigation\" data-role=\"navbar\" class=\"nav-glyphish-example ui-navbar ui-mini\" data-grid=\"d\"><ul class=\"ui-grid-d\"><li class=\"ui-block-a\"><a  href=\"#\" id=\"load\" data-icon=\"refresh\"><span class=\"ui-btn-inner\"><span class=\"ui-btn-text\">Load more</span><span class=\"ui-icon ui-icon-custom ui-icon-shadow\">&nbsp;</span></span></a></li><li class=\"ui-block-b\"><a class=\"ui-btn ui-btn-up-a\" href=\"profile.html\" id=\"pro\" data-icon=\"star\"><span class=\"ui-btn-inner\"><span class=\"ui-btn-text\">Profile</span><span class=\"ui-icon ui-icon-custom ui-icon-shadow\">&nbsp;</span></span></a></li><li class=\"ui-block-b\"><a class=\"ui-btn ui-btn-up-a\" href=\"posted.html\" id=\"pos\" data-icon=\"edit\"><span class=\"ui-btn-inner\"><span class=\"ui-btn-text\">Posted</span><span class=\"ui-icon ui-icon-custom ui-icon-shadow\">&nbsp;</span></span></a></li><li class=\"ui-block-b\"><a class=\"ui-btn ui-btn-up-a\" href=\"friends.html\" id=\"fri\" data-icon=\"user\"><span class=\"ui-btn-inner\"><span class=\"ui-btn-text\">Friends</span><span class=\"ui-icon ui-icon-custom ui-icon-shadow\">&nbsp;</span></span></a></li><li class=\"ui-block-b\"><a class=\"ui-btn ui-btn-up-a\" href=\"addfriends.html\" id=\"addfri\" data-icon=\"plus\"><span class=\"ui-btn-inner\"><span class=\"ui-btn-text\">addfriends</span><span class=\"ui-icon ui-icon-custom ui-icon-shadow\">&nbsp;</span></span></a></li></ul></div>";
