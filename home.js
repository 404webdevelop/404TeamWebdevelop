...
if (username == "None"){
	...
	document.getElementById("loginbutton").innerHTML ="<li><button id=\"signup\" onclick=\"signuppage()\"type=\"button\" class=\"btn btn-lg btn-primary\">Sign up</button></li> <li><span>fg</span></li>li><button id=\"signin\"onclick=\"signinbox()\"type=\"button\" class=\"btn btn-lg btn-default\">Sign in</button></li>";
}else{
